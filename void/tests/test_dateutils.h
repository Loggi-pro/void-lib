...
class VoidTest_Dateutils : UnityTestClass<VoidTest_Dateutils> {
	...
	public:
		...
		void static Date_ComparisonIsEqual() {
			TDate date(2014, 12, 30);
			TDate date_same(2014, 12, 30);
		...
		void static Date_ComparisonIsSameMonth() {
			TDate date(2014, 12, 30);
		...
		void static Date_ComparisonIsSameDay() {
			TDate date(2014, 12, 30);
			TDate date_same_other_year(2015, 12, 30);
		...
		void static Date_ComparisonIsNextMonthThan() {
			TDate date(2014, 12, 30);
		...
		void static Date_ComparisonIsPrevMonthThan() {
			TDate date(2014, 12, 30);
			TDate date_same(2015, 1, 31);
			TDate date_same2(2015, 2, 1);
			TDate date_notsame(2000, 1, 5);
		...
		void static Date_ComparisonIsPrevDayThan() {
		...
		void static Date_ComparisonIsNextDayThan() {
			TDate date(2015, 12, 31);
			TDate date_same(2015, 12, 30);
			TDate date_same2(2016, 1, 1);
			TDate date_notsame(2000, 1, 5);
		...
		void static Date_ComparisonIsSameYear() {
			TDate date(2015, 12, 31);
			TDate date_same(2015, 12, 30);
		...
		void static Date_ComparisonEquations() {
		...
		void static Date_DecDay_BetweenMonthWithDiffMaxDays() {
		...
		void static Date_DecYear_BetweenYearWithLeapDay() {
		...
		void static Date_IncYear_BetweenYearWithLeapDay() {
			TDate date(2016, 02, 29);
			date.DecYear();
		...
		void static Date_CalendarYearsBetweenn() {
			TDate date(2015, 12, 30);
		...
		/*IGNORE_void static Time_ToString() {
			TTime time(20, 59, 59);
			char string[10];
		...
		void static Time_ComparisonIsEqual() {
			TTime time(20, 59, 59);
			TTime time_same(20, 59, 59);
		...
		void static Time_SecondsMoreThan() {
			TTime time(13, 50, 1);
		...
		void static Time_ComparisonEquations() {
			TTime time(13, 50, 1);
			TTime time2(13, 50, 2);
			TTime time3(13, 51, 1);
			TTime time4(14, 51, 1);
		...
		void static DateTime_DefaultConstructor() {
			TDateTime dt;
		...
		void static DateTme_Constructor() {
		...
		void static DateTme_ConstructorFromDateTime() {
		...
		void static DateTme_ConstructorFromDate() {
			TDate date(2014, 12, 30);
			TDateTime dt(date);
			TEST_ASSERT_EQUAL(2014, dt.date.Year);
			TEST_ASSERT_EQUAL(12, dt.date.Month);
		...
		void static DateTme_DecrementDay() {
			TDateTime dt;
			dt.date.Day = 13;
			dt.date.Month = 3;
			dt.date.Year = 2019;
		...
		void static DateTme_FROM_NTP_TIME_NYI() {
			TDateTime dt;
			dt.FromNTPTime(3813969610, 0);
			TEST_ASSERT_EQUAL(2020, dt.date.Year);
			TEST_ASSERT_EQUAL(11, dt.date.Month);
			TEST_ASSERT_EQUAL(10, dt.date.Day);
			TEST_ASSERT_EQUAL(4, dt.time.Hour);
			TEST_ASSERT_EQUAL(0, dt.time.Minute);
			TEST_ASSERT_EQUAL(10, dt.time.Second);
			//not calc milliseconds
			TEST_ASSERT_EQUAL(0, dt.time.Millis);
		}

		void static DateTme_Clear() {
		...
		void static DateTime_Comparison() {
		...
		void static DateTime_ComparisonEquations() {
		...
		void static DateTime_ComparisonIsEqual() {
		...
		void static DateTime_HoursBetween() {
		...
		void static DateTime_MinutesBetween() {
		...
		void static DateTime_IncrMillis() {
		...
		void static DateTime_DecMillis() {
		...
		static void run() {
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTimeUtils);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_DefaultConstructor);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_Constructor);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ConstructorFromDate);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_Set);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_Clear);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_CopyFrom);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_CopyTo);
			//RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ToString);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_Comparison);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ComparisonIsEqual);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ComparisonIsSameMonth);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ComparisonIsSameDay);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ComparisonIsNextMonthThan);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ComparisonIsPrevMonthThan);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ComparisonIsPrevDayThan);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ComparisonIsNextDayThan);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ComparisonIsSameYear);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ComparisonEquations);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_IncDec);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_DecDay_BetweenMonthWithDiffMaxDays);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_DecYear_BetweenYearWithLeapDay);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_DecYear_BetweenYearWithLeapDay);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_MonthBetween);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_DaysBetween);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_CalendarYearsBetweenn);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_CheckIsValid);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Date_ChangeDigits);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_DefaultConstructor);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_Constructor);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_ConstructorFromtime);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_Clear);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_IsValid);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_Set);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_CopyFrom);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_CopyTo);
			//RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_ToString);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_Comparison);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_ComparisonIsEqual);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_SecondsMoreThan);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, Time_ComparisonEquations);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTime_DefaultConstructor);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_Constructor);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_ConstructorFromDateTime);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_ConstructorFromDate);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_Set);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_DecrementDay);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_FROM_NTP_TIME_NYI);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_Clear);
			//RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_ToString);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_ToDate);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_CopyFrom);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_CopyTo);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTme_IsValid);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTime_Comparison);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTime_ComparisonEquations);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTime_ComparisonIsEqual);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTime_HoursBetween);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTime_MinutesBetween);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTime_IncrMillis);
			RUN_TEST_CASE_CLASS(VoidTest_Dateutils, DateTime_DecMillis);
		}
};
