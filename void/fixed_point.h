...
namespace vd {
	...
	template <
	    ...
	    unsigned char F = vd::numeric_limits<B>::digits - I >
	/// A fixed point type.
	//!
	...
	class fixed_point {
			...
			friend class vd::fixed_point;

			/// Grant the numeric_limits specialization for this fixed_point class
			/// access to private members.
			friend class vd::numeric_limits<vd::fixed_point<B, I, F> >;
		...
		public:
			...
			fixed_point(
			    /// The value to convert.
			    float value)
				: value_((B)(value * power2<F>::value + (value >= 0 ? .5f : -.5f)))
			{ }
			...
			vd::fixed_point<B, I, F>& operator =(
			    /// The right hand side.
			    vd::fixed_point<B, I, F> const& rhs) {
				vd::fixed_point<B, I, F> temp(rhs);
				swap(temp);
				return *this;
			}
			...
			vd::fixed_point<B, I, F>& operator =(
			    /// The right hand side.
			    vd::fixed_point<B, I2, F2> const& rhs) {
				vd::fixed_point<B, I, F> temp(rhs);
				swap(temp);
				return *this;
			}
			...
			bool operator ==(
			    /// Right hand side.
			    vd::fixed_point<B, I, F> const& rhs) const {
				return
				    value_ == rhs.value_;
			}
			...
			vd::fixed_point<B, I, F> operator -() const {
				vd::fixed_point<B, I, F> result;
			...
			vd::fixed_point<B, I, F>& operator ++() {
				value_ += static_cast<B>(power2<F>::value);
				return *this;
			}
			fixed_point<B, I, F> operator ++(int) {
				fixed_point<B, I, F> temp = *this;
				++*this;
				return temp;
			}
			/// Decrement.
			...
			//! /return A reference to this object.
			vd::fixed_point<B, I, F>& operator --() {
				value_ = static_cast<B>(value_-power2<F>::value);
				return *this;
			}
			fixed_point<B, I, F> operator --(int) {
				fixed_point<B, I, F> temp = *this;
			...
			vd::fixed_point<B, I, F>& operator +=(
			    ...
			    vd::fixed_point<B, I, F> const& summand) {
				value_ += summand.value_;
				return *this;
			}
			fixed_point<B, I, F> operator+(const fixed_point<B, I, F>& b) {
				fixed_point<B, I, F> temp = *this;
				temp += b;
				return temp;
			}
			...
			vd::fixed_point<B, I, F>& operator -=(
			    ...
			    vd::fixed_point<B, I, F> const& diminuend) {
		...
		public:
			...
			vd::fixed_point<B, I, F>& operator *=(
			    ...
			    vd::fixed_point<B, I, F> const& factor) {
				value_ = static_cast<B>((static_cast< typename vd::fixed_point<B, I, F>::template
				          promote_type<B>::type>
			...
			vd::fixed_point<B, I, F>& operator /=(
			    ...
			    vd::fixed_point<B, I, F> const& divisor) {
				value_ = static_cast<B>((static_cast<typename vd::fixed_point<B, I, F>::template
				          promote_type<B>::type>
			...
			friend vd::fixed_point<B, I, F> fabs(
			    /// The argument to the function.
			    vd::fixed_point<B, I, F> x) {
				return x < vd::fixed_point<B, I, F>(0) ? -x : x;
			}
			...
			friend vd::fixed_point<B, I, F> ceil(
			    /// The argument to the function.
			    vd::fixed_point<B, I, F> x) {
				vd::fixed_point<B, I, F> result;
				result.value_ = x.value_ & ~(power2<F>::value - 1);
				return result + vd::fixed_point<B, I, F>(
			...
			friend vd::fixed_point<B, I, F> floor(
			    /// The argument to the function.
			    vd::fixed_point<B, I, F> x) {
				vd::fixed_point<B, I, F> result;
				result.value_ = x.value_ & ~(power2<F>::value - 1);
			...
			friend vd::fixed_point<B, I, F> fmod(
			    /// The argument to the function.
			    vd::fixed_point<B, I, F> x,
			    /// The argument to the function.
			    vd::fixed_point<B, I, F> y) {
				vd::fixed_point<B, I, F> result;
			...
			friend vd::fixed_point<B, I, F> modf(
			    /// The argument to the function.
			    vd::fixed_point<B, I, F> x,
			    /// The pointer to the integer part.
			    vd::fixed_point<B, I, F>* ptr) {
				vd::fixed_point<B, I, F> integer;
				integer.value_ = x.value_ & ~(power2<F>::value - 1);
				*ptr = x < vd::fixed_point<B, I, F>(0) ?
				       integer + vd::fixed_point<B, I, F>(1) : integer;
				vd::fixed_point<B, I, F> fraction;
				fraction.value_ = x.value_ & (power2<F>::value - 1);
				return x < vd::fixed_point<B, I, F>(0) ? -fraction : fraction;
			}
			...
			friend vd::fixed_point<B, I, F> exp(
			    /// The argument to the exp function.
			    vd::fixed_point<B, I, F> x) {
				// a[x] = exp( (1/2) ^ x ), x: [0 ... 31]
				vd::fixed_point<B, I, F> a[] = {
				...
				vd::fixed_point<B, I, F> e(2.718281828459045);
				vd::fixed_point<B, I, F> y(1);
			...
			friend vd::fixed_point<B, I, F> cos(
			    /// The argument to the cos function.
			    vd::fixed_point<B, I, F> x) {
				vd::fixed_point<B, I, F> x_ =
				    fmod(x, vd::fixed_point<B, I, F>(M_PI * 2));

				if (x_ > vd::fixed_point<B, I, F>(M_PI))
				{ x_ -= vd::fixed_point<B, I, F>(M_PI * 2); }

				vd::fixed_point<B, I, F> xx = x_ * x_;
				vd::fixed_point<B, I, F> y = - xx *
				                             vd::fixed_point<B, I, F>(1. / (2 * 3 * 4 * 5 * 6));
				y += vd::fixed_point<B, I, F>(1. / (2 * 3 * 4));
				y *= xx;
				y -= vd::fixed_point<B, I, F>(1. / (2));
				y *= xx;
				y += vd::fixed_point<B, I, F>(1);
				return y;
			}
			...
			friend vd::fixed_point<B, I, F> sin(
				...
				vd::fixed_point<B, I, F> xx = x_ * x_;
				vd::fixed_point<B, I, F> y = - xx *
				                             vd::fixed_point<B, I, F>(1. / (2 * 3 * 4 * 5 * 6 * 7));
				y += vd::fixed_point<B, I, F>(1. / (2 * 3 * 4 * 5));
				y *= xx;
				y -= vd::fixed_point<B, I, F>(1. / (2 * 3));
				y *= xx;
				y += vd::fixed_point<B, I, F>(1);
				y *= x_;
				return y;
			...
			friend vd::fixed_point<B, I, F> sqrt(
			    /// The argument to the square root function, a nonnegative fixed-point
			    /// value.
			    vd::fixed_point<B, I, F> x) {
				if (x < vd::fixed_point<B, I, F>(0)) {
					errno = EDOM;
					return 0;
				}

				typename vd::fixed_point<B, I, F>::template promote_type<B>::type op =
				    static_cast<typename vd::fixed_point<B, I, F>::template promote_type<B>::type>
				(
				    x.value_) << (I - 1);
				typename vd::fixed_point<B, I, F>::template promote_type<B>::type res = 0;
				typename vd::fixed_point<B, I, F>::template promote_type<B>::type one =
				    (typename vd::fixed_point<B, I, F>::template promote_type<B>::type)1 <<
				    (vd::numeric_limits<typename vd::fixed_point<B, I, F>::template promote_type<B>
				     ::type>::digits - 1);
...
namespace vd {
	...
	/******************************************************************************/
	/*                                                                            */
	/* numeric_limits<vd::fixed_point<B, I, F> >                                */
	/*                                                                            */
	/******************************************************************************/
	...
	template <
	    ...
	    /// The fractional part bit count of the fixed_point type.
	    unsigned char F >
	class numeric_limits<vd::fixed_point<B, I, F> > {
			friend class vd::fixed_point<B, I, F>;
		public:
			/// The fixed_point type. This numeric_limits specialization is specialized
			/// for this type.
			typedef vd::fixed_point<B, I, F> fp_type;
			...
			static const bool is_signed =
			    vd::numeric_limits<typename fp_type::base_type>::is_signed;
			...
			static fp_type (min)() {
				fp_type minimum;
				minimum.value_ = vd::numeric_limits<typename fp_type::base_type>::min();
				return minimum;
			}
			...
			static fp_type (max)() {
				fp_type maximum;
				maximum.value_ = vd::numeric_limits<typename fp_type::base_type>::max();
				return maximum;
			}
